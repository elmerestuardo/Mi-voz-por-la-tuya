...
<div class="inner-block">
  ...
  <div class="modal fade" id="eliminarev" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-default" id="eliminarevent">Eliminar</button>
...
<h2>Historial de eventos</h2>
        <br>
            <p>Lista detallada de todos los eventos realizados por la asociación.</p>
        <br> 
	...
	<div class="col-md-12 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="cargar-historial-eventos">
                                  <thead>
                                    <tr>
                                      <th>#</th>
                                      <th>Evento</th>
