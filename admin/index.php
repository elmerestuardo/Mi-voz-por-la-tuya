...
<html lang="es">
<head>
<title>Panel Admin - Escritorio</title>
...
<div class="main-page-charts">
   <div class="main-page-chart-layer1">
		<div class="col-md-6 chart-layer1-right">
            ...
            <div class="perfil-left"><h4>Mi Voz Por La Tuya</h4></div>
            <div class="perfil-right"><button class="glyphicon glyphicon-pencil" style="float: right;"></button></div>
            </div>
			<div class="malorm-bottom" id="info-usuario">
