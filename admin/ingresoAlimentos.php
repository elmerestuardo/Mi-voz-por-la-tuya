...
<div class="inner-block">
    ...
    <form  id="formularioAlimento" name="formularioAlimento" enctype="multipart/form-data" method="post" class="agregar-usuario">
 ...
 <input type="submit" class="btn btn-1 btn-warning"  name="Enviar" value="Registrar nuevo alimento">
